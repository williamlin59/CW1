/**    
  * Copyright (C) 2014, Dipartimento di Elettronica, Informazione e Bioingegneria (DEIB) - Politecnico di Milano
...
public abstract class EngineUtils {
	...
	public static boolean isInverseMeasure(int measureType) {
		return measureType == SimConstants.THROUGHPUT || measureType == SimConstants.SYSTEM_THROUGHPUT || measureType == SimConstants.DROP_RATE
