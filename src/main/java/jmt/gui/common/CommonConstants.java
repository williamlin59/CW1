...
public interface CommonConstants {
	...
	public final static String QUEUE_STRATEGY_RP = "RAND (Priority)";
	public final static String QUEUE_STRATEGY_SJFP = "SJF (Priority)";
	public final static String QUEUE_STRATEGY_LJFP = "LJF (Priority)";
	...
	public final static String CLASSES_DESCRIPTION = HTML_START + HTML_FONT_TITLE + "Classes Characteristics" + HTML_FONT_TIT_END + HTML_FONT_NORM
			...
			+ "<br/>" + "Open classes can be generated in a ClassSwitch station." +HTML_FONT_NOR_END + HTML_END;
