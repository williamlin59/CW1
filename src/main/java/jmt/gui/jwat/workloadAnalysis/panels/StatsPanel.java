...
public class StatsPanel extends WizardPanel implements CommonConstants, JWATConstants {
	...
	public final static String SAMPLING_TRIMMING_PANEL_DESC = HTML_START
			...
			+ HTML_FONT_TIT_END
			+ HTML_FONT_NORM
			+ "At this time you can apply any number of sampling operations and transformations to data with the constraint that you ca not apply any transformation after a sampling;"
